// Neuen Datensatz erstellen �ber Aside Men�
...
function submitPruefen() {
    ...
    if (fehler != "") {
        ...
        fehlertext += fehler;
        /*alert(fehlertext + "\nBitte f�llen Sie die Informationen noch aus. Danke.");*/
...
// Pr�fen der Eingabe f�r Date sonst ErrorLabel einblenden
...
// Pr�fen der Eingabe f�r Startzeit sonst ErrorLabel einblenden
